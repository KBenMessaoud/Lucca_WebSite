...
exports.mixinMapping = exports.cssClassesToUpdate = exports.cssClassMapping = exports.cssVarsToUpdate = exports.cssVariableMapping = void 0;
const mappings = {
    breakpoint: {
        xxxs: 'XXXS',
        hard: 'XXS',
...
exports.cssVariableMapping = expand({
...
exports.cssVarsToUpdate = new Set(Object.keys(exports.cssVariableMapping));
exports.cssClassMapping = expand({
    // Utilities
...
exports.cssClassesToUpdate = new Set(Object.keys(exports.cssClassMapping));
exports.mixinMapping = expand({
...
function expand(rawMapping) {
    function replaceValue(oldValue, map, newValue) {
    ...
    return Object.fromEntries(Object.entries(rawMapping).flatMap(([oldTemplate, newTemplate]) => {
        ...
        for (const placeholder of placeholders) {
            ...
            values = values.flatMap(([oldVal, newVal]) => Object.entries(mappings[map]).map(([key, value]) => [replaceValue(oldVal, map, key), replaceValue(newVal, map, value)]));
        }
        return values;
    }));
}
