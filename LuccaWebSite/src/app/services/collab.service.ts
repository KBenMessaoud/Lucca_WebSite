...
export class CollabService {
  //private baseUrl = 'https://imt-nantes.ilucca-demo.net/work-locations/api/schedule/available-work-locations';
  ...
  getOccupanciesCount(locationId: number, startDate: string, endDate: string): Observable<any> {
    return this.http.get(`${this.baseUrl}/${locationId}/occupancies?start=${startDate}&end=${endDate}`);
